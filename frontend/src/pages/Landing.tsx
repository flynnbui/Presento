        ...
        >
          ...
          <div className="flex flex-col col-start-2 col-span-5 space-y-4 justify-center">
            <h1 className="font-bold text-2xl leading-10">
              Another powerful presentation tool
            </h1>
            <h2 className="leading-7 text-gray-900">
              Create stunning presentations effortlessly with beautifully
              crafted slides, ready to captivate any audience.
            </h2>

            {/* Get Started Button */}
            <div className="flex">
              <Button
                className="dark:bg-zinc-900 dark:text-zinc-50 shadow dark:hover:bg-zinc-900/90 "
